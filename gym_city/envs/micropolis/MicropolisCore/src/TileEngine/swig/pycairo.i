...
////////////////////////////////////////////////////////////////////////
// Python specific SWIG typemaps for pycairo.
// Don Hopkins, Internet Archive
...
%typemap(out) cairo_t * {
    ...
    // SWIG cairo_t * out typemap from pycairo.i
...
%typemap(in) cairo_surface_t * {
    ...
    // SWIG cairo_surface_t * in typemap from pycairo.i
...
%typemap(out) cairo_surface_t * {
    ...
    // SWIG cairo_surface_t * out typemap from pycairo.i
