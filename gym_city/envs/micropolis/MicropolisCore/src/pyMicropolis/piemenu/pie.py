...
class PieItem:
    ...
    def draw(self, context, pcontext, playout):
...
class PieMenu:
    ...
    def validate(self, context, pcontext, playout):
        ...
        self.layout(context, pcontext, playout)
...
#           event.area.height)
        ...
        self.drawHeader(context, pcontext, playout)
        self.drawFooter(context, pcontext, playout)
        ...
        for item in self.items[::-1]:
            if item.index == curItem:
                ...
                item.draw(context, pcontext, playout)

        # Draw the current item last so it overlaps all other items.
        if drawItemLater:
            drawItemLater.draw(context, pcontext, playout)

        self.drawOverlay(context, pcontext, playout)


    def drawBackground(self, context, pcontext, playout):
    ...
    def drawHeader(self, context, pcontext, playout):
